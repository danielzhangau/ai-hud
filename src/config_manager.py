...
class ConfigManager:
    ...
    def get_fusion_params(self):
        ...
        return {
            ...
            "vote_window_s":      self.get_float("fusion", "npu_vote_window_s"),
            "window_size":        self.get_int("fusion", "npu_window_size"),
            "release_dissent":    self.get_int("fusion", "npu_release_dissent"),
        }
